        ...
        <div className="bg-gray_900 h-[1074px] md:px-5 relative shadow-bs7 w-full">
          <div className="h-[1066px] md:h-[986px] m-auto pb-[23px] w-full">
            <Img
              ...
              alt="bg"
            />
            <div className="absolute bottom-[26%] flex flex-col inset-x-[0] items-center justify-start mx-auto w-[55%]">
              <div className="bg-gradient3  p-px rounded-lg w-full ">
              ...
              <Text
                className="font-futuramaxicglight font-normal leading-[32.00px] mt-16 text-center text-white_A700_01 w-[95%] sm:w-full"
                variant="body5"
              ></Text>
              <Button
                className="mt-[33px]"
...
export default Frame48095564Page;

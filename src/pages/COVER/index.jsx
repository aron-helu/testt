...
const COVERPage = () => {
  return (
    <>
      <div className="bg-yellow_A700 flex flex-col font-poppins items-center justify-end mx-auto md:pl-10 sm:pl-5 pl-[50px] pt-[50px] w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly max-w-[1664px] mx-auto w-full">
          <div className="flex md:flex-1 flex-col justify-start md:mt-0 mt-[142px] w-[69%] md:w-full">
            ...
            <div className="flex flex-row font-poppins gap-3 items-start justify-start mt-[268px] w-[205px]">
              <Text
                className="font-normal not-italic text-blue_gray_800 text-left w-auto"
                variant="body12"
              >
                ©2023
              </Text>
              <div className="flex flex-col items-start justify-end w-auto">
                <Text
                  className="font-normal mt-1 not-italic text-blue_gray_800 text-left w-auto"
                  variant="body12"
                >
                  iking.io
                </Text>

  ...
  return (
    <>
      <div className="bg-white_A700_01 flex flex-col font-montserrat items-center justify-end mx-auto w-full">
        <div className="md:h-[1620px] h-[1961px] md:px-5 relative w-full">
          <PRODUCTPAGEDESCRIPTIONStackrectangleten
            ...
            buyNow="Buy Now"
          />
          <div className="absolute bottom-[0] flex flex-col gap-[50px] inset-x-[0] items-center justify-start mx-auto w-[74%]">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-center w-[54%] md:w-full">
              <div className="flex flex-col gap-2 items-center justify-start w-[21%] md:w-full">
                <Text
              ...
              <Text
                className="font-bold md:ml-[0] ml-[93px] text-center text-gray_900 tracking-[0.20px] uppercase w-auto"
                variant="body14"
              >
                Reviews (4)
              </Text>
              <Text
                className="font-bold md:ml-[0] ml-[109px] text-center text-gray_900 tracking-[0.20px] uppercase w-auto"
                variant="body14"
              >
                Additional Information
              </Text>
            </div>
            <div className="flex flex-col font-futuramaxicglight items-start justify-start w-full">
              <Text
                className="font-normal leading-[22.00px] text-gray_800 text-left w-full"
                variant="body14"
              >
                Praesent nec fermentum ipsum. Etiam turpis neque, laoreet quis
                placerat vel, faucibus non tortor. Quisque ut augue et augue
                consequat blandit nec vel leo. Donec aliquam mauris vel ultrices
                viverra. Donec pulvinar et odio eget commodo. Maecenas massa
                odio, tincidunt vitae erat sed, sodales malesuada nisl. Sed
                consequat libero enim, sed porttitor tortor lacinia et. Donec
                gravida luctus purus a semper. Fusce id tincidunt eros.
                Vestibulum sit amet nunc id lorem vestibulum euismod id vitae
                tortor. Pellentesque ac consectetur dui. Aenean nec maximus
                neque. Nulla facilisi. Vivamus non ex sodales, malesuada mi ac,
                pulvinar nibh.
              </Text>
              <div className="flex flex-col items-center justify-start mt-[49px] w-[21%] md:w-full">
                <div className="flex flex-col items-start justify-start w-full">
                  <div className="flex flex-row gap-[29px] items-center justify-start w-[72%] md:w-full">
                    <Text
                      className="font-normal text-gray_800 text-left w-auto"
                      variant="body14"
                    >
                      Material:
                    </Text>
                  ...
                  <div className="flex flex-row gap-[45px] items-start justify-start mt-[17px] w-full">
                    <Text
                      className="font-normal text-gray_800 text-left w-auto"
                      variant="body14"
                    >
                  ...
                  <div className="flex flex-row gap-12 items-start justify-start mt-[15px] w-[62%] md:w-full">
                    <Text
                      className="font-normal text-gray_800 text-left w-auto"
                      variant="body14"
                    >
                  ...
                  <div className="flex flex-row gap-[34px] items-center justify-start mt-[17px] w-[54%] md:w-full">
                    <Text
                      className="font-normal text-gray_800 text-left w-auto"
                      variant="body14"
                    >
              ...
              <Text
                className="font-normal leading-[22.00px] mt-[38px] text-gray_800 text-left w-full"
                variant="body14"
              >
                ...
                posuere cubilia curae; Nullam commodo malesuada placerat. Proin
                blandit, ipsum commodo laoreet finibus, orci purus pharetra
                elit, sit amet dapibus mauris quam id odio. Fusce ac lectus
                eros. Quisque turpis libero, interdum eu dictum eu, fermentum
                sed orci. Mauris id elit tellus.
              </Text>
            </div>
          </div>
          <Header className="absolute flex flex-col font-futuramaxicgdemi inset-x-[0] items-center justify-center mx-auto top-[0] w-full" />
        </div>
        <div className="flex flex-col font-futuramaxicgbold items-center justify-start mt-[183px] md:px-5 w-auto md:w-full">
          <Text className="text-gray_900 text-left w-auto" variant="body4">
            Customers who bought this also bough
          </Text>
        </div>
        <div className="flex flex-col font-futuramaxicgbook items-center justify-start mt-[696px] md:px-5 w-[19%] md:w-full">
        ...
        <div className="flex flex-col font-montserrat items-start justify-start mt-[54px] py-20 self-stretch w-auto md:w-full">
          <div className="flex md:flex-col flex-row gap-[52px] items-start justify-start self-stretch w-auto md:w-full">
            <div className="flex flex-col items-center justify-start md:px-5 w-[32%] md:w-full">
              <div className="h-[445px] sm:h-[674px] relative w-full">
                <div className="bg-white_A700_01 flex flex-col h-full items-center justify-start m-auto w-full">
              ...
              <div className="flex flex-col items-center justify-start w-full">
                <div className="flex flex-col items-end justify-start md:pl-10 sm:pl-5 pl-[49px] w-full">
                  <div className="flex sm:flex-col flex-row gap-[43px] items-center justify-end ml-auto w-full">
                    ...
                    <Img
                      src="images/img_printedsummerdress_414x242.png"
